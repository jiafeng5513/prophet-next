...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "AGENT_ORCHESTRATOR_MODE": {
        ...
        "description": "Pipeline mode when AGENT_ARCH=multi. 'quick' (tech+intel→decision), 'deep' (full pipeline + debate + risk debate + auto skill selection).",
        "category": "agent",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "validation": {"enum": ["quick", "deep", "standard", "full", "specialist", "strategy", "skill"]},
        "display_order": 61,
    },
    ...
    "AGENT_PARALLEL_PIPELINE": {
        "title": "并行管线",
        "description": "启用独立 Agent（Technical + Intel）并行执行，减少总耗时。",
        "category": "agent",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "AGENT_DEBATE_ENABLED": {
        "title": "多空辩论",
        "description": "启用 Bull/Bear 多空辩论环节（仅 full/specialist 模式生效）。开启后 BullResearcher 和 BearResearcher 将交叉论证。",
        "category": "agent",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "AGENT_DEBATE_ROUNDS": {
        "title": "辩论轮数",
        "description": "Bull/Bear 辩论的轮数。每轮双方各出一次论点并反驳对方。",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "AGENT_RISK_DEBATE_ENABLED": {
        "title": "多视角风险讨论",
        "description": "启用多视角风险辩论（仅 full/specialist 模式生效）。多个风险视角 Agent 并行评估后由 RiskDebateManager 裁决。",
        "category": "agent",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "AGENT_REFLECTION_ENABLED": {
        "title": "反思机制",
        "description": "启用反思系统。记录历史决策偏差，下次分析时注入提示以校正系统性偏见。",
        "category": "agent",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "AGENT_REFLECTION_LOOKBACK_DAYS": {
        "title": "反思回溯天数",
        "description": "反思系统查看过去多少天的历史决策来检测偏差模式。",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "AGENT_DEEP_THINK_MODEL": {
        "title": "深度推理模型",
        "description": "用于 Decision/Risk Agent 的深度推理模型。留空则使用 Agent 主模型。",
        "category": "agent",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "AGENT_QUICK_THINK_MODEL": {
        "title": "快速推理模型",
        "description": "用于 Technical/Intel Agent 的快速模型。留空则使用 Agent 主模型。",
        "category": "agent",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "AGENT_MODEL_ASSIGNMENT": {
        "title": "Agent 模型分配",
        "description": "JSON 格式自定义各 Agent 使用的模型层级。例如: {\"decision\": \"deep_think\", \"technical\": \"quick_think\"}",
        "category": "agent",
        "data_type": "json",
        "ui_control": "textarea",
        "is_sensitive": False,
